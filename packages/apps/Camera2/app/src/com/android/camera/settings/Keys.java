...
public class Keys {
    ...
    public static final String KEY_VIDEO_QUALITY_EXTERNAL = "pref_video_quality_external_key";
    ...
    public static final String KEY_PICTURE_SIZE_EXTERNAL = "pref_camera_picturesize_external_key";
