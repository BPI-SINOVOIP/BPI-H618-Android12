...
public class Camera2OneCameraManagerImpl implements OneCameraManager {
    ...
    public Camera2OneCameraManagerImpl(CameraManager cameraManger) {
        ...
        if (mCameraManager != null) {
            ...
            findFirstCameraFacing(Facing.EXTERNAL);
        }
    }
    ...
    /** Returns the ID of the first external-facing camera. */
    private String findFirstExternalCameraId() {
        ...
        Log.d(TAG,"findFirstExternalCameraId:" + cameraId);
        return cameraId;
    }
