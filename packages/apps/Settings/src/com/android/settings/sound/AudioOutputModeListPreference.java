...
public class AudioOutputModeListPreference extends RestrictedListPreference {
    private static final String TAG = "AudioOutputModeListPreference";
    private EnforcedAdmin mAdmin;
    private final CharSequence[] mInitialEntries;
    private final CharSequence[] mInitialValues;

    public AudioOutputModeListPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
