 ...
 */
@Keep
public class PairedDeviceOperationFragment extends SettingsPreferenceFragment {
    ...
    public static PairedDeviceOperationFragment newInstance(String deviceAddress, String deviceName,
            int deviceImgId) {
        final Bundle b = new Bundle(3);
        prepareArgs(b, deviceAddress, deviceName, deviceImgId);
        final PairedDeviceOperationFragment f = new PairedDeviceOperationFragment();
        f.setArguments(b);
        return f;
    }
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        setPreferencesFromResource(R.xml.bluetooth_rename_unpair, null);
    ...
    public static class ChangeNameFragment extends GuidedStepSupportFragment {
        ...
        public long onGuidedActionEditedAndProceed(GuidedAction action) {
            if (!TextUtils.equals(action.getTitle(),
                ...
                final PairedDeviceOperationFragment fragment =
                        (PairedDeviceOperationFragment) getTargetFragment();
    ...
    private static class UnpairReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (bondState == BluetoothDevice.BOND_NONE && Objects.equals(mDevice, device)) {
                ...
                if (mFragment instanceof PairedDeviceOperationFragment) {
                    ((PairedDeviceOperationFragment) mFragment).navigateBack();
        ...
        private void unpairDevice() {
            if (mDevice != null) {
                ...
                if (state != BluetoothDevice.BOND_NONE) {
                    ((PairedDeviceOperationFragment) getTargetFragment()).setUnpairing(true);
