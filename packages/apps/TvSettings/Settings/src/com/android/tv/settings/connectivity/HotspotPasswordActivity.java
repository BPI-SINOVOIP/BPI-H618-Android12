...
import com.android.tv.settings.connectivity.setup.HotspotPasswordState;
import com.android.tv.settings.connectivity.setup.HotspotPasswordInvalidState;
import com.android.tv.settings.connectivity.util.State;
import com.android.tv.settings.connectivity.util.StateMachine;
import com.android.tv.settings.core.instrumentation.InstrumentedActivity;

/**
 * Manual-style modify wifi hotspot password
 */
public class HotspotPasswordActivity extends InstrumentedActivity
            implements State.FragmentChangeListener {
    private static final String TAG = "HotspotPasswordActivity";
    private State mHotspotPasswordState;
    private State mSaveSuccessState;
    private State mHotspotPasswordInvalidState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHotspotPasswordState = new HotspotPasswordState(this);
        mSaveSuccessState = new SaveSuccessState(this);
        mHotspotPasswordInvalidState = new HotspotPasswordInvalidState(this);

        mStateMachine.addState(
                mHotspotPasswordState,
                StateMachine.CONTINUE,
                mSaveSuccessState);
        mStateMachine.addState(
                mHotspotPasswordState,
                StateMachine.SOFTAP_PASSWORD_INVALID,
                mHotspotPasswordInvalidState
        );

        /* Hotspot password Setup Invalid */
        mStateMachine.addState(
                mHotspotPasswordInvalidState,
                StateMachine.CONTINUE,
                mHotspotPasswordState
        ...
        mStateMachine.setStartState(mHotspotPasswordState);
