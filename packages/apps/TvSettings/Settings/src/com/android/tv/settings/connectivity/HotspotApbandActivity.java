...
import com.android.tv.settings.connectivity.setup.HotspotApbandState;
import com.android.tv.settings.connectivity.util.State;
import com.android.tv.settings.connectivity.util.StateMachine;
import com.android.tv.settings.core.instrumentation.InstrumentedActivity;

/**
 * Manual-style modify wifi hotspot AP Band
 */
public class HotspotApbandActivity extends InstrumentedActivity
            implements State.FragmentChangeListener {
    private static final String TAG = "HotspotApbandActivity";
    private State mHotspotApbandState;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mHotspotApbandState = new HotspotApbandState(this);
        ...
        mStateMachine.setStartState(mHotspotApbandState);
