...
const std::string OEM_UNLOCK = "unlock";
const std::string OEM_LOCK = "lock";
const std::string OEM_EFEX = "efex";
const std::string USERDATA_DEV_PATH = "/dev/block/by-name/userdata";
const std::string UDISK_DEV_PATH = "/dev/block/by-name/UDISK";
