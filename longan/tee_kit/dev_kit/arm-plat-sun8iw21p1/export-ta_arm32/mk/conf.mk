...
ta_arm32-platform-cflags := -mcpu=cortex-a7 -Os -g3 -fpic -mthumb -fno-short-enums -fno-common -mno-unaligned-access -mfloat-abi=soft -funwind-tables
ta_arm32-platform-aflags := -pipe -g -mcpu=cortex-a7 -mfpu=neon
