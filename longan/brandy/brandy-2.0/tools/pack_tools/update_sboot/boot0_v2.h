...
#define BOOT0_SPI_NOR_START_ADDR                                               \
	0 /* add for spi nor. by Gary,2009-12-8 11:47:17*/
#define SPI_NOR_SIZE_FOR_BOOT0                                                 \
	SZ_64K /* add for spi nor. by Gary,2009-12-8 11:47:17*/
...
typedef struct _boot0_private_head_t {
	...
	__u8 reserve[2];
	unsigned int dram_para
		[32]; /* DRAM patameters for initialising dram. Original values is arbitrary,*/
...
typedef struct _boot_extend_head_t {
	...
	// unsigned int dram_para[15][32]; /* version:1.0ext dram params*/
	unsigned int dram_para[32][32]; /* version:2.0ext dram params*/
	__u8			reserve1[12];
} boot_extend_head_t;
