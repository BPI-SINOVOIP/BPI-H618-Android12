...
typedef unsigned int
	__stk; /* Each stack entry is 32-bit wide                              */
typedef unsigned int
	__cpu_sr; /* Define size of CPU status register (PSR = 32 bits)           */

typedef float
	__fp32; /* Single precision floating point                              */
typedef double
	__fp64; /* Double precision floating point                              */
