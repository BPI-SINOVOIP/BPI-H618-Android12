...
#define EDP_ERR(fmt, ...)			printf("[EDP_ERR]: "fmt, ##__VA_ARGS__)
#define EDP_WRN(fmt, ...)			printf("[EDP_WRN]: "fmt, ##__VA_ARGS__)
#define EDP_INFO(fmt, ...)			printf("[EDP_INFO]: "fmt, ##__VA_ARGS__)

#ifdef EDP_DRV_DEBUG
#define EDP_DRV_DBG(fmt, ...)	printf("[EDP_DRV]: "fmt, ##__VA_ARGS__);
#else
#define EDP_DRV_DBG(fmt, ...)
#endif

#ifdef EDP_CORE_DEBUG
#define EDP_CORE_DBG(fmt, ...)	printf("[EDP_CORE]: "fmt, ##__VA_ARGS__);
...
#ifdef EDP_LOW_DEBUG
#define EDP_LOW_DBG(fmt, ...)	printf("[EDP_LOW]: "fmt, ##__VA_ARGS__);
#else
#define EDP_LOW_DBG(fmt, ...)
#endif

#ifdef EDP_EDID_DEBUG
#define EDP_EDID_DBG(fmt, ...)	printf("[EDP_EDID]: "fmt, ##__VA_ARGS__);
#else
