...
const struct de_feat de350_mode0_features = {
	.num_screens = 1,
...
const struct de_feat de350_mode1_features = {
	.num_screens = 2,
...
const struct de_feat de350_mode2_features = {
	.num_screens = 2,
...
const struct de_feat de350_mode3_features = {
	.num_screens = 2,
