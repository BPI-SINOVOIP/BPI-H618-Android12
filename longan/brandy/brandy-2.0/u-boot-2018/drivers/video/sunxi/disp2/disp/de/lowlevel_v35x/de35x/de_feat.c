...
extern struct de_feat de350_mode0_features;
extern struct de_feat de350_mode1_features;
extern struct de_feat de350_mode2_features;
extern struct de_feat de350_mode3_features;
...
s32 de_feat_init_config(struct de_feat_init *feat_init)
{
	if (feat_init->chn_cfg_mode == 0)
		de_cur_features = &de350_mode0_features;
	else if (feat_init->chn_cfg_mode == 1) {
		de_cur_features = &de350_mode1_features;
	} else if (feat_init->chn_cfg_mode == 2) {
		de_cur_features = &de350_mode2_features;
	} else if (feat_init->chn_cfg_mode == 3) {
		de_cur_features = &de350_mode3_features;
	} else
		return -1;
