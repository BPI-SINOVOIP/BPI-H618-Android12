...
const struct flash_info spi_nor_ids[] = {
	...
	{
		INFO("gd25f128f", 0xc84318, 0x0, 64 * 1024, 256,
			SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ |
	...
	{ INFO("w25m512jv", 0xef7119, 0, 64 * 1024, 1024, SECT_4K | SPI_NOR_DUAL_READ | SPI_NOR_QUAD_READ | SPI_NOR_STACK_DIE | SPI_NOR_SKIP_SFDP) },
#endif
