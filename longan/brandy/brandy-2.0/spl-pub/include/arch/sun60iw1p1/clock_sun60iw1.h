...
#include <config.h>
#include <arch/cpu.h>
#include <arch/sun60iw1p1/clock_autogen.h>
...
#define CE_SCLK_ON	  (CE_CLK_REG_CE_CLK_GATING_SECURE_DEBUG)

#define CE_GATING_BIT  (CE_BGR_REG_CE_GATING_OFFSET)
#define CE_GATING_PASS (CE_BGR_REG_CE_GATING_SECURE_DEBUG)
...
#define CE_DEASSERT	(CE_BGR_REG_CE_RST_SECURE_DEBUG)
