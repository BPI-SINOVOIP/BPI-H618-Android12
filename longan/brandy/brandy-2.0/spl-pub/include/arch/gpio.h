...
#define CFG_BIT_WIDTH                          4
#define PULL_BIT_WIDTH                         2
#define DRV_BIT_WIDTH                          4
...
#define SUN8I_GPC_SPIF		2
#define SUN55I_GPC_SPIF		5
#define SUNXI_FPGA_SPI0         5
...
/* GPIO pin deiving config */
#define SUNXI_GPIO_DRV_LEVEL0	0
#define SUNXI_GPIO_DRV_LEVEL1	1
#define SUNXI_GPIO_DRV_LEVEL2	2
#define SUNXI_GPIO_DRV_LEVEL3	3
