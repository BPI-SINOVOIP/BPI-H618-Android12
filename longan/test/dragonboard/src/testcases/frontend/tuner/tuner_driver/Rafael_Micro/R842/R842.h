...
#define R842_VERSION     "R842_v1.8I"
#define R842_VER_NUM     8
#define R842_CHIP_ID     0x97
#define R842_ATV_CIF_5M  FALSE     //by CTMR
//----------------------------------------------------------//
//                   Type Define                            //
//----------------------------------------------------------//
...
typedef enum _R842_Standard_Type  //Don't remove standand list!!
{
	...
	R842_ERROR_TYPE = 99,    // add by Allwinner
}R842_Standard_Type;
...
//----------------------------------------------------------//
#define R842_Delay_MS	mdelay//Sleep //madianqi-20200912,change as mdelay for AW PLATFORM
