...
#define  R842_DVBT_DTMB_MTC     FALSE    
#define  R842_ATV_MTC_390N_27N  FALSE   
#define  R842_FOR_LGIT          FALSE 
#define  R842_FOR_SEMCO_MODULE  FALSE   //Xtal 13pF

#if(R842_FOR_LGIT==TRUE || R842_FOR_SEMCO_MODULE==TRUE)
#define  R842_ALL_IMR_NOR      TRUE    //TRUE: all use IMR normal
#elif(R842_DVBT_DTMB_MTC==TRUE)
#define  R842_ALL_IMR_NOR      FALSE   //FALSE for MTC
#else
#define  R842_ALL_IMR_NOR      TRUE   //TRUE(new CTMR) or FALSE(old CTMR)
#endif


#define  R842_FILTER_GAIN_DELAY   2  
#define  R842_FILTER_CODE_DELAY   2   
#define  R842_XTAL_CHK_DELAY      10
#define  R842_PLL_LOCK_DELAY      10
UINT32   R842_ADC_READ_DELAY = 2;   
...
#elif (R842_DVBT_DTMB_MTC==TRUE || R842_ATV_MTC_390N_27N==TRUE) //MTC
UINT8   R842_XTAL_CAP = 17;    //17pF
#else
...
UINT8 R842_iniArray[3][R842_REG_NUM] = {                  
	...
	//     0x18  0x19  0x1A  0x1B  0x1C  0x1D  0x1E  0x1F 
		   0x01, 0x1E, 0x00, 0x4D, 0xDC, 0x3B, 0x59, 0x59,
...
UINT8 R842_TF_MID_CAL_Array[3][R842_REG_NUM] = {   //24M/16M/27M
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  //read only					
	   ...
	   0x61, 0x1E, 0x71, 0x59, 0xE6, 0x38, 0x38, 0x08,					
...
UINT8 R842_IMR_CAL_Array[3][R842_REG_NUM] = {   //24M/16M/27M
	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  //read only					
	   0x0E, 0xF2, 0x31, 0x80, 0xB0, 0x39, 0x27, 0x8F,                                                   	   													  						 
	   0x00, 0x57, 0x86, 0x30, 0x60, 0x00, 0x77, 0x69,                                                 	   
	   0x41, 0xEC, 0x91, 0x00, 0x00, 0x5F, 0xAE, 0x42, 				
	   0x21, 0x3F, 0x51, 0xEB, 0xDE, 0x38, 0x38, 0xF8,					
	   0x63, 0xF6, 0xC2, 0x45, 0x55, 0xFB, 0x6C, 0x01 },

	{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  //read only					
	   0x0E, 0xF2, 0x31, 0x80, 0xB0, 0x39, 0x28, 0x8F,                                                   	   													  						 
	   0x00, 0x57, 0x86, 0x30, 0x60, 0x00, 0x77, 0x69,                                                 	   
...
{
 {0,11,19,21,36,55,74,92,111,131,149,170,190,210,234,243,252,264,277,287,295,301,310,318,327,334,341,344,352,359},
 {0, 8,18,21,35,49,68,86,106,126,143,163,184,205,228,238,249,261,273,283,290,296,304,314,324,333,341,339,348,356},
 {0, 9,18,21,37,52,68,87,103,121,136,154,170,187,204,215,227,242,257,270,280,288,300,311,322,332,341,346,356,365},
 {0,15,25,27,39,54,71,89,105,122,137,155,171,186,202,213,225,240,257,271,282,292,306,316,326,335,342,353,361,367},
 {0,11,25,28,37,56,72,91,109,126,144,164,183,202,222,232,242,255,269,281,290,298,309,317,324,331,335,342,348,352},
 {0, 6,26,27,43,66,84,105,126,145,164,185,207,227,249,260,271,283,297,308,317,324,334,344,354,364,373,369,379,387},
 {0, 1,15,17,29,44,58,73,89,106,120,135,150,165,180,191,205,219,236,249,260,270,284,296,309,321,333,329,341,352}
};

static UINT16 R842_Lna_Sharp_Acc_Gain[7][30] = 
{
 {70,71,71,72,90,107,124,145,164,183,201,221,242,262,286,286,286,298,310,320,328,334,343,343,344,344,344,346,354,361},
 {74,74,74,74,90,107,125,145,163,182,200,220,241,262,285,285,285,297,309,319,326,332,340,340,340,340,340,340,347,356},
 {84,85,85,85,100,116,133,150,168,184,200,218,235,251,269,269,269,283,299,311,321,330,342,342,342,342,342,347,357,366},
 {104,104,104,104,117,130,144,158,174,189,202,218,232,247,262,262,262,276,293,307,319,328,342,342,342,342,342,353,361,367},
 {95,95,95,95,107,121,135,150,167,183,198,215,233,251,270,270,270,283,297,308,318,325,336,336,336,336,336,342,348,352},
 {115,115,115,115,129,143,158,175,193,211,228,248,267,286,307,307,307,320,334,345,355,362,372,372,372,372,372,368,378,387},
 {114,114,114,114,123,135,147,161,174,187,200,213,227,240,254,254,254,268,285,299,310,320,333,333,333,333,333,329,341,352}
};
...
R842_Sys_Info_Type R842_Sys_Sel(R842_Standard_Type R842_Standard)
{
	...
	case R842_DVB_T2_6M_IF_5M: 
		...
		R842_Sys_Info.BW=1;                  //BW=7M
#if(R842_ALL_IMR_NOR==TRUE)
		R842_Sys_Info.FILT_CAL_IF=7500;      //CAL IF
		R842_Sys_Info.HPF_COR=6;             //R24[3:0]=6
#else
		R842_Sys_Info.FILT_CAL_IF=7920;      //CAL IF
		R842_Sys_Info.HPF_COR=6;             //R24[3:0]=6
	...
	case R842_DTMB_8M_IF_5M: 
		...
		R842_Sys_Info.BW=0;                  //BW=8M
#if(R842_ALL_IMR_NOR==TRUE)  
		R842_Sys_Info.FILT_CAL_IF=8750;      //CAL IF  
		R842_Sys_Info.HPF_COR=11;            //R24[3:0]=8
#else
		R842_Sys_Info.FILT_CAL_IF=8800;      //CAL IF  
		R842_Sys_Info.HPF_COR=10;            //R24[3:0]=10
#endif		
	...
	if (R842_Standard < R842_ATV_SIZE)  //ATV
	{
		...
		R842_Sys_Info.FILT5_AUTO_COMP=3;    //3         (R18[6:5]=3)
	...
	switch(R842_Standard)
	{
		...
		case R842_SECAM_L1_INV_CIF_5M:	
			...
			else if(R842_DetectTfType==R842_UL_USING_390NH) //Low=390n
				R842_SetTfType = R842_TF_390N_39N;
			else  //Low=270n
	...
	#if(R842_ATV_MTC_390N_27N==TRUE)
		R842_SetTfType = R842_TF_390N_27N;		
	#endif
#endif
			 break;
...
#if(R842_FOR_LGIT==TRUE) //? use 390NH
			if(R842_DetectTfType==R842_UL_USING_BEAD) //Low=Bead
				R842_SetTfType = R842_TF_BEAD_68N;	
			else if(R842_DetectTfType==R842_UL_USING_390NH) //Low=390n
				R842_SetTfType = R842_TF_390N_39N;
	...
	case R842_SECAM_L1_INV_CIF_5M:	
		...
		if(RF_freq<R842_LNA_MID_LOW[R842_SetTfType])  //low band
		{
			...
			else //390n
			{
				...
				//181.25M, 1/2RF
				if((RF_freq<183250) && (RF_freq>=179250)) //need LPF_Q:180 Q enhance
				{
					R842_SysFreq_Info.LNA_TOP=1;              // LNA TOP=1                (R37[3:0]=4'b1110)
					R842_SysFreq_Info.LNA_VTL_H=0x38;	      // LNA VTL/H=0.64/1.14      (R38=0x38)		
					R842_SysFreq_Info.RF_TOP=2;               // RF TOP=2                 (R37[6:4]=3'b101)
					R842_SysFreq_Info.RF_VTL_H=0x38;          // RF VTL/H=0.64/1.14       (R39=0x38)
...
//			R842_SysFreq_Info.MIXER_GAIN_LIMIT=0x20;    // Mixer Gain Limit=8
	...
	case R842_DVB_T2_1_7M_IF_5M:
		...
		{
			if(R842_DetectMidTfType==R842_MID_USING_39NH) //mid=39
			{
...
#if(R842_FOR_LGIT==TRUE)
		if(RF_freq<R842_LNA_MID_LOW[R842_SetTfType])  //low band (270n)
			R842_SysFreq_Info.RF_TOP=4;
		else if(RF_freq>750000)
			R842_SysFreq_Info.RF_TOP=4;
		else
			R842_SysFreq_Info.RF_TOP=5;
#else
		R842_SysFreq_Info.RF_TOP=5;              // RF TOP=5             
#endif
		R842_SysFreq_Info.RF_VTL_H=0x6B;         // RF VTL/H=0.94/1.44   (R39=0x6B)
...
//		R842_SysFreq_Info.MIXER_AMP_LPF=1;       //1 
#if(R842_FOR_LGIT==TRUE)
		R842_SysFreq_Info.MIXER_AMP_LPF=2;        // 2
#else
		R842_SysFreq_Info.MIXER_AMP_LPF=1;        // 1		
#endif		
		R842_SysFreq_Info.DET_BW_LPF=1;          //enhance amp
	...
	if(R842_Initial_done_flag==FALSE)
	{
		...
		if(R842_IMR_done_flag==FALSE)
		{
			...
			if(R842_TF_Check() != R842_Success) {
				FE_LOGE("R842_TF_Check fail");
				return R842_Fail;
			}

			//start IMR calibration
			if(R842_Cal_Prepare(R842_IMR_CAL) != R842_Success) {
				FE_LOGE("R842_Cal_Prepare fail");
				return R842_Fail;
			}

			//Full K node 2
			if(R842_IMR(2, TRUE, R842_IMR_NOR) != R842_Success) {
				FE_LOGE("Full K node 2 fail");
				return R842_Fail;
			}

			if(R842_IMR(1, FALSE, R842_IMR_NOR) != R842_Success) {
				FE_LOGE("Full K node 1 fail");
				return R842_Fail;
			}

			if(R842_IMR(0, FALSE, R842_IMR_NOR) != R842_Success) {
				FE_LOGE("Full K node 0 fail");
				return R842_Fail;
			}

			//Full K node 3
			if(R842_IMR(3, FALSE, R842_IMR_NOR) != R842_Success) {
				FE_LOGE("Full K node 3 fail");
				return R842_Fail;
			}
...
R842_ErrCode R842_TF_Check(void)
{
	...
	R842_I2C_Len.RegAddr = 0;
	R842_I2C_Len.Len = 2;    
	if(I2C_Read_Len_R842(&R842_I2C_Len) != R842_Success)
	{
		I2C_Read_Len_R842(&R842_I2C_Len);
	}
...
#if (R842_ATV_MTC_390N_27N==TRUE)
	R842_DetectTfType = R842_UL_USING_390NH;
#endif
	return R842_Success;
}
...
R842_ErrCode R842_Xtal_Check(void)
{
	...
	R842_I2C.RegAddr = 47;
	R842_Array[47] = R842_Array[47] & 0xFD;
	R842_I2C.Data = R842_Array[47];
	if(I2C_Write(&R842_I2C) != R842_Success) {
		FE_LOGE("set pll autotune = 64kHz fail");
		return R842_Fail;
	}
...
R842_ErrCode R842_Cal_Prepare(UINT8 u1CalFlag)
{
	 ...
	 {
	    case R842_IMR_CAL:
				Cal_Info.RFBUF_OUT = 1;                     //from RF_Buf ON
				Cal_Info.TF_PATH = 0x00;                     //TF cal OFF, -6dB	OFF
				Cal_Info.LNA_POWER = 1;                    //LNA power OFF
				Cal_Info.RFBUF_POWER = 1;                //RF Buf power OFF
				Cal_Info.MIXER_AMP_GAIN = 6;          //manual 6
				Cal_Info.MIXER_BUFFER_GAIN = 15;     // max (no use)
				Cal_Info.LNA_GAIN = 31;                       // max (no use)
		...
		case R842_IMR_LNA_CAL:						    
				Cal_Info.RFBUF_OUT = 0;                     //from RF_Buf Off
				Cal_Info.TF_PATH = 0x30;                     //TF cal ON, -6dB ON
				Cal_Info.LNA_POWER = 1;                     //LNA power OFF
				Cal_Info.RFBUF_POWER = 0;                 //RF Buf power ON
				Cal_Info.MIXER_AMP_GAIN = 6;          //manual 6
				Cal_Info.MIXER_BUFFER_GAIN = 0;     // min(0)
				Cal_Info.LNA_GAIN = 31;                       // max
			break;
	...
	R842_I2C.Data = R842_Array[47];
	if(I2C_Write(&R842_I2C) != R842_Success) {
		FE_LOGE("set pll autotune = 64kHz (fast) fail");
		return R842_Fail;
	}
      return R842_Success;
}
...
R842_ErrCode R842_IMR(UINT8 IMR_MEM, UINT8 IM_Flag, UINT8 Rev_Mode)
{
	...
	if(R842_Xtal==16000)  //16M	
		...
		FE_LOGE("R842_IMR - R842_Xtal=%d not support", R842_Xtal);
		return R842_Fail;
	}
	...
	{
		//IMR MUX (LO, RF)
		if(R842_MUX(RingFreq - R842_IMR_IF, RingFreq, R842_STD_SIZE) != R842_Success) {
			FE_LOGE("R842_IMR - IMR MUX (LO, RF) fail");
			return R842_Fail;
		}

		//IMR PLL
		if(R842_PLL((RingFreq - R842_IMR_IF), R842_IMR_IF, R842_STD_SIZE) != R842_Success) {
			FE_LOGE("R842_IMR - IMR PLL fail");
			return R842_Fail;
		}
	...
	else  //Reverse Mode
	{
		...
		if(R842_PLL((RingFreq + R842_IMR_IF), R842_IMR_IF, R842_STD_SIZE) != R842_Success)  //IMR PLL
			return R842_Fail;
...
R842_ErrCode R842_PLL(UINT32 LO_Freq, UINT16 IF_Freq, R842_Standard_Type R842_Standard)//ok
{
	...
	else  
	{
		...
		else //spur-area
		{
			...
			//else -- explicitly assigning value to itself
			//	XtalDivQ = XtalDivQ;
			...
			if(R842_Chip==R842_MP)
			{
				if(R842_Standard < R842_ATV_SIZE) //ATV
				{
					...
					//Clk Out
					if(XtalDivQ==7 || XtalDivQ==17 || XtalDivQ==27)
						ClkOut = 0; //on
					else
						ClkOut = 1; //off

					//CP offset 
					if(XtalDivQ==4 || XtalDivQ==6 || XtalDivQ==7 || XtalDivQ==10 || XtalDivQ==13
						|| XtalDivQ==22 || XtalDivQ==23 || XtalDivQ==26)
						CP_Offset = 1;  //30
					else
						CP_Offset = 0;  //off	
				}
				else  //DTV
				{
					...
					//CP offset 
					if(XtalDivQ==4 || XtalDivQ==6 || XtalDivQ==7 || XtalDivQ==9 || XtalDivQ==10
						|| XtalDivQ==14 || XtalDivQ==16 || XtalDivQ==18 || XtalDivQ==19 || XtalDivQ==21 || XtalDivQ==22 || XtalDivQ==23)
						CP_Offset = 1;  //30
					else
						CP_Offset = 0;  //off					
				}
			...
			else  //MT chip
			{
				if(R842_Standard < R842_ATV_SIZE) //ATV 
				{
					...
					//Clk Out
					if(XtalDivQ==7 || XtalDivQ==13 || XtalDivQ==19 || 
					...
					//CP offset 
					if(XtalDivQ==2 || XtalDivQ==4 || XtalDivQ==7 || XtalDivQ==10 || XtalDivQ==14 || 
						XtalDivQ==20 || XtalDivQ==22 || XtalDivQ==26)
						CP_Offset = 1;  //30
					else
						CP_Offset = 0;  //off	
#else
					...
					//Clk Out
					if(XtalDivQ==7 || XtalDivQ==13 || XtalDivQ==17 || XtalDivQ==18 || 
						XtalDivQ==23 || XtalDivQ==27)
						ClkOut = 0; //on
					else
						ClkOut = 1; //off
					...
					//CP offset 
					if(XtalDivQ==4 || XtalDivQ==6 || XtalDivQ==10 || XtalDivQ==14 || XtalDivQ==26)
						CP_Offset = 1;  //30
					else
						CP_Offset = 0;  //off	
				...
				{
					if(R842_Xtal==16000) //16MHz Xtal, normal
					{
						switch(XtalDivQ)					
						{
						case 6:
					...
					default: //12,14,16,17,19,21,23,25,26,36,37
						R842_XtalDiv = R842_XTAL_DIV1_11;
						break;
					}
					...
					//Clk Out
					if(XtalDivQ==2 || XtalDivQ==7 || XtalDivQ==12 || XtalDivQ==13 
						|| XtalDivQ==15 || XtalDivQ==18)
						ClkOut = 0; //on
					else
						ClkOut = 1; //off
...
#if (R842_DVBT_DTMB_MTC==TRUE)
	if(R842_Chip==R842_MP)  //T2
	{
		 switch(R842_Standard)
		 {
		 case R842_DVB_T_6M_IF_5M:
		 ...
		 case R842_DTMB_6M_IF_5M:
			 ...
			 //if((RF_Freq==537500) || (RF_Freq==546500) || (RF_Freq==554000) || (RF_Freq==561500) || (RF_Freq==570500))
			 if((RF_Freq>=474000) && (RF_Freq<=626000))
			 {
				 R842_XtalDiv = R842_XTAL_DIV4_22;		
			 }			 
			 break;
	...
	R842_I2C.Data = R842_Array[47];
	if(I2C_Write(&R842_I2C) != R842_Success) {
		FE_LOGE("set pll autotune = 1khz fail");
		return R842_Fail;
	}
...
{	 
	...
	if(R842_ATV_IF==R842_NORMAL)
    	...
    	R842_Sys_Info1 = R842_Sys_Sel_8296(RT_Standard);  //LGIT
	else
	    R842_Sys_Info1 = R842_Sys_Sel(RT_Standard);

	// Filter Calibration	
/*
	if(RT_Standard<R842_ATV_SIZE)    //ATV
	    u1FilCalGap = R842_Fil_Cal_Gap;
	else
	    u1FilCalGap = 8;   //? 13
*/
    ...
    R842_pre_standard = RT_Standard;
		...
		// Set LPF Lsb bit
		R842_I2C.RegAddr = 22;
		R842_Array[22] = (R842_Array[22] & 0xFE) | (R842_Fil_Cal_LpfLsb[RT_Standard]);  //R22[0]
		R842_I2C.Data = R842_Array[22];
		if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
		...
		// Set LPF fine code
		R842_I2C.RegAddr = 22;
		R842_Array[22] = (R842_Array[22] & 0xE1) | (R842_Fil_Cal_code[RT_Standard]<<1);  //R22[4:1]
		R842_I2C.Data = R842_Array[22];
		if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
		...
		// Set LPF coarse BW
		R842_I2C.RegAddr = 22;
		R842_Array[22] = (R842_Array[22] & 0x9F) | (R842_Fil_Cal_BW[RT_Standard]<<5);  //R22[6:5]
		R842_I2C.Data = R842_Array[22];
		if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
...
R842_ErrCode R842_SetFrequency(R842_Set_Info R842_INFO)
{
	 ...
	 if(R842_Mixer_Mode==R842_IMR_REV)
	 {
		...
		if(R842_Chip==R842_MP)  //T2
		{
			 ...
			 case R842_DTMB_6M_IF_5M:
				 ...
				 if(R842_INFO.RF_KHz==474000)
					 LO_KHz = LO_KHz + 500; 
				 else if(R842_INFO.RF_KHz==490000)
					 LO_KHz = LO_KHz - 500;
				 else if(R842_INFO.RF_KHz==498000)
					 LO_KHz = LO_KHz + 500;
				 else if(R842_INFO.RF_KHz==514000)
					 LO_KHz = LO_KHz - 500;
				 else if(R842_INFO.RF_KHz==522000)
					 LO_KHz = LO_KHz + 500;
				 else if(R842_INFO.RF_KHz==538000)				 
					 LO_KHz = LO_KHz - 500;  				 
				 else if(R842_INFO.RF_KHz==546000)				 
					 LO_KHz = LO_KHz + 500;			 				
				 else if(R842_INFO.RF_KHz==562000)				 
					 LO_KHz = LO_KHz - 500;				 
				 else if(R842_INFO.RF_KHz==570000)				 
					 LO_KHz = LO_KHz + 500;
				 else if(R842_INFO.RF_KHz==586000)
					 LO_KHz = LO_KHz - 500;
				 else if(R842_INFO.RF_KHz==594000)
					 LO_KHz = LO_KHz + 500;
				 else if(R842_INFO.RF_KHz==610000)
					 LO_KHz = LO_KHz - 500;
				 else if(R842_INFO.RF_KHz==618000)
					 LO_KHz = LO_KHz + 500;
				 else
					 LO_KHz = LO_KHz;				 
	...
	vco_bank_read = R842_I2C_Len.Data[2] & 0x3F;
...
#if(R842_FOR_LGIT==TRUE)  //ADC off
	 R842_I2C.RegAddr = 8;		
	 R842_Array[8] = (R842_Array[8] & 0xBF) | 0x40; //R8[6]=1
	 R842_I2C.Data = R842_Array[8];
	 if(I2C_Write(&R842_I2C) != R842_Success)
		 return R842_Fail;	
#else
	 ...
	 if(R842_INFO.R842_Standard<R842_ATV_SIZE)  //ATV
	 {
		...
		// Set LPF fine code+2 
		R842_I2C.RegAddr = 22;
		R842_Array[22] = (R842_Array[22] & 0xE0) | (R842_Fil_Cal_code[R842_INFO.R842_Standard]*2+R842_Fil_Cal_LpfLsb[R842_INFO.R842_Standard]+2);  //R22[4:0]
		R842_I2C.Data = R842_Array[22];
		if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
		...
		// Set HPF corner-2 
		R842_I2C.RegAddr = 24;
		R842_Array[24] = (R842_Array[24] & 0xF0) | (R842_Sys_Info1.HPF_COR-2);
		R842_I2C.Data = R842_Array[24];
		if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
#endif
		...
		if(R842_Chip==R842_MP)  //T2
		{
			 if((R842_INFO.RF_KHz>90000) && (R842_INFO.RF_KHz<98000))	//96, +2/-6	 		 
			 ...
			 else if((R842_INFO.RF_KHz>306000) && (R842_INFO.RF_KHz<314000))	//312, +2/-6	 
				 ...
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x00;  //0.7mA,000
			 else if((R842_INFO.RF_KHz>546000) && (R842_INFO.RF_KHz<554000))	//552, +2/-6	 
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x04;  //0.6mA,001
	 ...
	 {		 			
		...
		case R842_DTMB_6M_IF_5M:
			...
			//LNA_RF charge
			R842_I2C.RegAddr = 15;
			if(R842_INFO.RF_KHz<R842_LNA_MID_LOW[R842_SetTfType])
				R842_Array[15] = (R842_Array[15] & 0xDF) | (0<<5);  	//6xch
			else if((R842_INFO.RF_KHz>440000) && (R842_INFO.RF_KHz<700000))
				R842_Array[15] = (R842_Array[15] & 0xDF) | (0<<5);  	//6xch
			else
				R842_Array[15] = (R842_Array[15] & 0xDF) | (R842_SysFreq_Info1.LNA_RF_CHARGE<<5);  
			R842_I2C.Data = R842_Array[15];
			if(I2C_Write(&R842_I2C) != R842_Success)
			 ...
			 R842_I2C.RegAddr = 44;
			 if(R842_INFO.RF_KHz<R842_LNA_MID_LOW[R842_SetTfType])
				 R842_Array[44] = (R842_Array[44] & 0xF0) | 0x01;   //0.3u/0.9u
			 else if((R842_INFO.RF_KHz>440000) && (R842_INFO.RF_KHz<700000))
				 R842_Array[44] = (R842_Array[44] & 0xF0) | 0x01;   //0.3u/0.9u
			 else
				 R842_Array[44] = (R842_Array[44] & 0xF0) | R842_SysFreq_Info1.LNA_DIS_SLOW_FAST;  
		...
		default:  //other DTV
			//LNA_RF charge
			R842_I2C.RegAddr = 15;
			if(R842_INFO.RF_KHz<120000)
				R842_Array[15] = (R842_Array[15] & 0xDF) | (0<<5);  	//6xch
			else if((R842_INFO.RF_KHz<450000) && (R842_INFO.RF_KHz>R842_LNA_MID_LOW[R842_SetTfType]))
				R842_Array[15] = (R842_Array[15] & 0xDF) | (0<<5);  	//6xch
			else
				R842_Array[15] = (R842_Array[15] & 0xDF) | (R842_SysFreq_Info1.LNA_RF_CHARGE<<5);  
			R842_I2C.Data = R842_Array[15];
		...
		//ATSC fine tune: LO_buffer_DC=high; Mixer_current=high, 3thFilterGain(auto)
		switch(R842_INFO.R842_Standard)
		{
		case R842_ATSC:
		case R842_ATSC_IF_5M:
			R842_Array[17] = (R842_Array[17] & 0xFB) | 0x00; //LO_buffer_DC=high, R17[2]=0
			//R842_Array[11] = (R842_Array[11] & 0x7F) | 0x00; //Mixer_current=high, R11[7]=0
			R842_Array[11] = (R842_Array[11] & 0x7F) | 0x80; //Mixer_current=low, R11[7]=1

			if(R842_INFO.RF_KHz<443000)
				R842_Array[24] = (R842_Array[24] & 0x7F) | 0x00;   //normal
			else if((R842_INFO.RF_KHz>=443000) && (R842_INFO.RF_KHz<600000))
				R842_Array[24] = (R842_Array[24] & 0x7F) | 0x80;   //+1dB
			else if((R842_INFO.RF_KHz>=600000) && (R842_INFO.RF_KHz<783000))
				R842_Array[24] = (R842_Array[24] & 0x7F) | 0x00;   //normal
			else
				R842_Array[24] = (R842_Array[24] & 0x7F) | 0x80;   //+1dB
		...
		default:
			...
			R842_Array[17] = (R842_Array[17] & 0xFB) | 0x04; //LO_buffer_DC=low, R17[2]=1
			R842_Array[11] = (R842_Array[11] & 0x7F) | 0x80; //Mixer_current=low, R11[7]=1
			break;
		}
		...
		if(R842_Chip==R842_MP)  //mT2 (DTV)
		{
			 if((R842_INFO.RF_KHz>92000) && (R842_INFO.RF_KHz<100000))	//96, +4/-4
				 ...
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x0C;  //0.4mA,011	
			 else if((R842_INFO.RF_KHz>380000) && (R842_INFO.RF_KHz<388000))	//384, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x0C;  //0.4mA,011
			 else if((R842_INFO.RF_KHz>428000) && (R842_INFO.RF_KHz<436000))	//432, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x0C;  //0.4mA,011
			 else if((R842_INFO.RF_KHz>452000) && (R842_INFO.RF_KHz<460000))	//456, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x00;  //0.7mA,000
			 else if((R842_INFO.RF_KHz>524000) && (R842_INFO.RF_KHz<532000))	//528, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x08;  //0.5mA,010
		...
		else //MT (DTV)
		{
			if(R842_Xtal==16000) //16MHz Xtal
			{
			 if((R842_INFO.RF_KHz>44000) && (R842_INFO.RF_KHz<52000))	//48, +4/-4			 
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100
			 else if((R842_INFO.RF_KHz>60000) && (R842_INFO.RF_KHz<68000))	//64, +4/-4			 
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100
			 else if((R842_INFO.RF_KHz>268000) && (R842_INFO.RF_KHz<276000))	//272, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100		 
			 else if((R842_INFO.RF_KHz>348000) && (R842_INFO.RF_KHz<356000))	//352, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100		
			 else if((R842_INFO.RF_KHz>380000) && (R842_INFO.RF_KHz<388000))	//384, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100				
			 else if((R842_INFO.RF_KHz>396000) && (R842_INFO.RF_KHz<404000))	//400, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100
			 else if((R842_INFO.RF_KHz>764000) && (R842_INFO.RF_KHz<772000))	//768, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100				
			 else if((R842_INFO.RF_KHz>796000) && (R842_INFO.RF_KHz<804000))	//800, +4/-4
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100
			 else if((R842_INFO.RF_KHz>460000) && (R842_INFO.RF_KHz<564000))	//(464~560)+4/-4         
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x10;  //0.3mA,100
			 else
				 R842_Array[31] = (R842_Array[31] & 0xE3) | 0x14;  //0.2mA,101	
			}
		...
		if(R842_Chip==R842_MP)  //T2
		{
			 ...
			 case R842_DTMB_6M_IF_5M:
				 ...
				 if((R842_INFO.RF_KHz==490000) || (R842_INFO.RF_KHz==514000) || (R842_INFO.RF_KHz==538000) || 
					 (R842_INFO.RF_KHz==538000) || (R842_INFO.RF_KHz==562000) || (R842_INFO.RF_KHz==586000) || (R842_INFO.RF_KHz==610000))
				 {
					 //cap=2
					 R842_SetXtalCap(2);
					 //LPF-1				
					 R842_Array[22] = (R842_Array[22] & 0xE0) | ((R842_Fil_Cal_code[R842_INFO.R842_Standard]<<1)+R842_Fil_Cal_LpfLsb[R842_INFO.R842_Standard]-1);  
					 //HPF-2 (10->8)
					 R842_Array[24] = (R842_Array[24] & 0xF0) | (R842_Sys_Info1.HPF_COR-2);
				 }
				 else if((R842_INFO.RF_KHz==474000) || (R842_INFO.RF_KHz==498000) || (R842_INFO.RF_KHz==522000) ||
					 (R842_INFO.RF_KHz==546000) || (R842_INFO.RF_KHz==570000) || (R842_INFO.RF_KHz==594000) || (R842_INFO.RF_KHz==618000))
				 {	 
					 //cap not change 
					 R842_SetXtalCap(R842_XTAL_CAP);
					 //LPF+3				
					 R842_Array[22] = (R842_Array[22] & 0xE0) | ((R842_Fil_Cal_code[R842_INFO.R842_Standard]<<1)+R842_Fil_Cal_LpfLsb[R842_INFO.R842_Standard]+3);  
					 //HPF+2 (10->12)
					 R842_Array[24] = (R842_Array[24] & 0xF0) | (R842_Sys_Info1.HPF_COR+2);
				 }
				 else if((R842_INFO.RF_KHz==482000) || (R842_INFO.RF_KHz==506000) || (R842_INFO.RF_KHz==530000) || 
					 (R842_INFO.RF_KHz==554000) || (R842_INFO.RF_KHz==578000) || (R842_INFO.RF_KHz==602000) || (R842_INFO.RF_KHz==626000))
				 {
					 //cap not change
					 R842_SetXtalCap(R842_XTAL_CAP);
					 //LPF
					 R842_Array[22] = (R842_Array[22] & 0xE0) | ((R842_Fil_Cal_code[R842_INFO.R842_Standard]<<1)+R842_Fil_Cal_LpfLsb[R842_INFO.R842_Standard]);  
					 //HPF
					 R842_Array[24] = (R842_Array[24] & 0xF0) | (R842_Sys_Info1.HPF_COR);
				 }
				 else
...
R842_ErrCode R842_Standby(void)
{
	...
	for(i=0; i<R842_REG_NUM; i++)
	{
	 ...
	 //Q1.5 off
	 R842_I2C.RegAddr = 14;
	 R842_Array[14] = (R842_Array[14] & 0x7F); 
	 R842_I2C.Data = R842_Array[14];
	 if(I2C_Write(&R842_I2C) != R842_Success)
			return R842_Fail;
...
R842_ErrCode R842_SetIfLpf(UINT32 LPF_Cor_Freq)
{
	...
	// Set LPF coarse BW
	R842_I2C.RegAddr = 0x17;
	R842_Array[23] = (R842_Array[23] & 0xF3) | (R842_Bandwidth<<2);  //R23[3:2]
	R842_I2C.Data = R842_Array[23];
	if(I2C_Write(&R842_I2C) != R842_Success)
		return R842_Fail;
...
{ 
	...
	//RT_Standard = RT_Standard; -- explicitly assigning value to itself
	...
	if((R842_Array[20]&0x60)==0x60)
	{
		if((R842_Array[19]&0x10)==0x10) //enb_poly_gain
			mixer_max = 14;
		else
			mixer_max = 12;
	}
	else if((R842_Array[20]&0x60)==0x40)
		mixer_max = 10;
	else if((R842_Array[20]&0x60)==0x20)
		mixer_max = 8;
	else
		mixer_max = 6;
	...
	else if(RF_Freq_Khz>=236000 && RF_Freq_Khz<484000)   // 236~484M
	{
		u1FreqIndex = 3;
		//u2FreqFactor = 100;
		u2FreqFactor = 70; //-3
	}
	else if(RF_Freq_Khz>=484000 && RF_Freq_Khz<524000)   // 484~524M
	{
		u1FreqIndex = 4;
		u2FreqFactor = 120;
	}
	else if(RF_Freq_Khz>=524000 && RF_Freq_Khz<674000)   // 524~674M
	{
		u1FreqIndex = 5;
		//u2FreqFactor = 150;
		u2FreqFactor = 120; //-3
	...
	rf_total_gain = acc_lna_gain + R842_Rf_Acc_Gain[RF_gain2] + 
		R842_Mixer_Acc_Gain[RF_gain3] + R842_Filter_Acc_Gain[RF_gain4];
...
R842_ErrCode R842_GetIfRssi(UINT32 *VgaGain)
{
	...
	Dlg_I2C_Len.Len = 2;
	if(I2C_Read_Len_R842(&Dlg_I2C_Len) != R842_Success) // read data length
	{
		I2C_Read_Len_R842(&Dlg_I2C_Len);
	}
...
{
	 //Enable Poly Gain (13~14)
	 R842_I2C.RegAddr = 19;
	 R842_Array[19] = (R842_Array[19] & 0xEF) | (1<<4);  
     R842_I2C.Data = R842_Array[19];
     if(I2C_Write(&R842_I2C) != R842_Success)
        return R842_Fail;

	 //VGA Pin level(+4); delta(20dBc); 
	 R842_I2C.RegAddr = 25;
