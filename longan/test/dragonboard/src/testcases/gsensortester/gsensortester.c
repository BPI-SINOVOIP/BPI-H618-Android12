...
int main(int argc, char *argv[])
{
    ...
    float z=0.0f;
    float g=0.0f;
    int pridata = atoi(argv[5]);
    int is_manualtest = atoi(argv[6]);
    float convert;
