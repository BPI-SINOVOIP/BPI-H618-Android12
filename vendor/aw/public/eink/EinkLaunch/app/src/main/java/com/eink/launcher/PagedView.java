...
public abstract class PagedView extends ViewGroup {
    ...
    private static final int PAGE_SNAP_ANIMATION_DURATION = 1;//550;
 ...
 */
        ...
        if (mContentIsRefreshable) {
            ...
            if (page < count) {
                ...
                for (int i = 0; i < count; ++i) {
                    ...
                    Paged layout = (Paged) getPageAt(i);
    ...
    protected void invalidatePageData(int currentPage, boolean immediateAndOnly) {
        ...
        if (mContentIsRefreshable) {
            Log.i("debug", "ContentIsRefreshable");
    ...
    private static final int HOW_REFRESH = 10;
    private static final boolean ENABLE_EINK_REFRESH = true;

    private void einkRefresh() {

        if (ENABLE_EINK_REFRESH) {
            mEntryCount++;
            if (mEntryCount >= HOW_REFRESH) {
                mEntryCount = 0;
                //Log.d("debug","eink full refresh");
