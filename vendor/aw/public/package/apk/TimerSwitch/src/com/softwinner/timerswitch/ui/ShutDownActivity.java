...
public class ShutDownActivity extends AppCompatActivity{
    ...
    private static final String TAG = "TAG_ShutDownActivity";
    ...
    private List<Alarm> shutdownAlarms;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(actionBar != null){
            ...
            actionBar.setTitle(getResources().getString(R.string.timing_shutdown));
        }
        ...
        shutdownAlarms = model.findShutdownAlarms();

        adapter = new AlarmAdapter(this, shutdownAlarms, new AlarmAdapter.SwitchAlarmCallBack() {
            @Override
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_add:
                ...
                intent.putExtra(AlarmCreateOrUpdateActivity.KEY_ALARM_LABEL,Alarm.LABEL_ALARM_SHUTDOWN);
    ...
    private void initRecyclerView(){
        if(shutdownAlarms == null || shutdownAlarms.size() == 0){
            ll_no_alarm.setVisibility(View.VISIBLE);
            ll_showAlarms.setVisibility(View.GONE);
        } else {
            rvSetAdapter();
