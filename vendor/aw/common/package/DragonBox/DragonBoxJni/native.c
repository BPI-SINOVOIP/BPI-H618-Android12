...
#include <jni.h>
#include <string.h>
/* Header for class com_softwinner_dragonbox_jni_ReadPrivateJNI */
#include "secure_storage/api.h"

#include <android/log.h>
#define LOG_TAG "DragonBoxJni"
...
/*
 * Class:     com_softwinner_dragonbox_jni_ReadPrivateJNI
 * Method:    native_init
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_com_softwinner_dragonbox_jni_ReadPrivateJNI_nativeInit
 ...
 */
JNIEXPORT jstring JNICALL Java_com_softwinner_dragonbox_jni_ReadPrivateJNI_nativeGetParameter
 ...
 */
JNIEXPORT jboolean JNICALL Java_com_softwinner_dragonbox_jni_ReadPrivateJNI_nativeSetParameter
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_softwinner_dragonbox_jni_ReadPrivateJNI_nativeRelease
  (JNIEnv *env, jclass thiz){
 LOGD("release");
}
