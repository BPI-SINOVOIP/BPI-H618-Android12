...
public class WifiConfigurationActivity extends BaseSettingsActivity
    ...
    public void onConnectivityChange(Intent intent) {
        ...
        if (intentAction.equals(ConnectivityManager.CONNECTIVITY_ACTION)
                || intentAction.equals(ConnectivityManager.EXTRA_NETWORK_INFO)) {
            /*
                ...
                if (wifiInfo != null) {
                    ...
                    if (wifiConfiguration != null) {
                        ...
                        int proxySettingsResourceId =
                            (ipConfiguration.getProxySettings() == ProxySettings.NONE) ?
    ...
    private String getNetworkName() {
        ...
        if (networkInfo != null && networkInfo.getType() == ConnectivityManager.TYPE_WIFI) {
            ...
            if (wifiInfo != null) {
                name = WifiInfo.sanitizeSsid(wifiInfo.getSSID());
            }
        }
        return name;
    }
