...
public class StorageInfoManager {
    public static final String TAG = "DragonBox-StorageInfoManager";
    ...
    private boolean testRW(String path) {
        ...
        //AndroidP does not support write permission of path /storage/uuid/ for the third  party app now.
        //but support system app to write /mnt/media_rw.
        if(fileName.startsWith("/storage/"))
            fileName = fileName.replaceFirst("storage","mnt/media_rw");
        Log.e(TAG,"fileName is "+fileName);
