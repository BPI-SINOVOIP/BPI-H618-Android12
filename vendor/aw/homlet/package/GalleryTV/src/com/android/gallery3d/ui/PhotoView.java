...
public class PhotoView extends GLView {
    ...
    public PhotoView(AbstractGalleryActivity activity) {
        ...
        mGifPlayIcon = new ResourceTexture(mContext, R.drawable.ic_control_play);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
            ...
            mGestureListener.onSingleTapUp(0,0);
        }
    ...
    class FullPicture implements Picture {
        ...
        private void drawTileView(GLCanvas canvas, Rect r) {
            ...
            if (mIsGif) drawGifPlayIcon(canvas, s);
    ...
    // Draw the gif play icon (in the place where the spinner was)
    private void drawGifPlayIcon(GLCanvas canvas,int side) {
        int s = side / ICON_RATIO;
        // Draw the gif play icon at the center
        mGifPlayIcon.draw(canvas, -s / 2, -s / 2, s, s);
    }
