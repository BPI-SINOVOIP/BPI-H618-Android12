...
public class DataManager implements StitchingChangeListener {
    ...
    private HashSet<NotifyBroker> mNotifierSets =
        new HashSet<NotifyBroker>();
    ...
    public void forceNotifyBrokerOnChange(){
        for(NotifyBroker broker: mNotifierSets){
