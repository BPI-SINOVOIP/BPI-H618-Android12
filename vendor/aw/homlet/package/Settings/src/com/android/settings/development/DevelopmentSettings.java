...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    private EnableUsb0DevicePreferenceController mEnableUSB0DeviceController;
    ...
    public void onCreate(Bundle icicle) {
        ...
        mEnableUSB0DeviceController = new EnableUsb0DevicePreferenceController(getActivity());
        ...
        mEnableUSB0DeviceController.displayPreference(getPreferenceScreen());
    ...
    private void setPrefsEnabledState(boolean enabled) {
        ...
        mEnableUSB0DeviceController.enablePreference(enabled);
    ...
    private void updateAllOptions() {
        ...
        mEnableUSB0DeviceController.updateState(null);
        mHaveDebugSettings |= mEnableAdbController.haveDebugSettings();
        mHaveDebugSettings |= mEnableUSB0DeviceController.isUSB0DeviceEnabled();
    ...
    private void resetDangerousOptions() {
        ...
        mEnableUSB0DeviceController.resetPreference();
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (mEnableUSB0DeviceController.handlePreferenceTreeClick(preference)) {
            return true;
        }
