...
public class ConnectivityListener {
    ...
    private final EthernetManager mEthernetManager = null;
    ...
    public static class ConnectivityStatus {
        ...
        boolean isWifiConnected() {
            return mNetworkType == NETWORK_WIFI_OPEN || mNetworkType == NETWORK_WIFI_SECURE || mWifiConnected;
        }
        ...
        public String toString() {
            return new StringBuilder()
                ...
                .append("  mWifiConnected ").append(mWifiConnected)
                .toString();
        }
    };
    ...
    public ConnectivityListener(Context context, Listener listener) {
        ...
        //mFilter.addAction(ConnectivityManager.EXTRA_INET_CONDITION);
        mFilter.addAction(ConnectivityManager.EXTRA_NETWORK_INFO);
    ...
    public String getEthernetIpAddress() {
        LinkProperties linkProperties =
                mConnectivityManager.getLinkProperties(mWifiManager.getCurrentNetwork());
    ...
    public void forgetWifiNetwork() {
        ...
        if (networkId != -1) {
            ...
            mConnectivityStatus.mWifiConnected = false;
        }
    }
    ...
    public List<ScanResult> getAvailableNetworks() {
        ...
        currentConnectedSSID = WifiInfo.sanitizeSsid(currentConnectedSSID);
            ...
            switch (networkInfo.getType()) {
                ...
                case ConnectivityManager.TYPE_ETHERNET:
                    ...
                    if (wifiInfo.getNetworkId() != -1 && wifiInfo.getIpAddress() != 0) {
                        mConnectivityStatus.mWifiConnected = true;
                        Log.d(TAG, "Wifi is connected :" + mConnectivityStatus.mWifiConnected);
                    }
