...
#define CDX_STREAM_TYPE_AUDIO_DRA      0xb1 // add by ganqiuye
...
#define CDX_STREAM_TYPE_VIDEO_AVS2       0xd2
...
static const cdx_int32 DRA_SamplingRate[]=
{
    8000,  //0
    11025, //1
    12000, //2
...
//#define CACHE_BUFFER_SIZE (20*64*1024) //should be times of SizeToReadEverytime.
typedef enum {
    OK = 0,
    ERROR_MALFORMED = -1,
    ERROR_SECTION = -2
...
/*
    cdx_bool bResetCacheBufferSizeFlag;
    FILE* pFile;
    cdx_bool bSaveStreamFlag;
*/
};
