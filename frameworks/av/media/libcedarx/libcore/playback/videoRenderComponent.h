...
void VideoRenderCompSetDiDemo(VideoRenderComp* v, int enable, int left, int top, int right, int bottom);

void VideoRenderCompSetDiTnr(VideoRenderComp* v, int enable, int mode, int strength);

void VideoRenderCompSetDiFmd(VideoRenderComp* v, int enable);
#endif
