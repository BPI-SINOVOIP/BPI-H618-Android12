...
protected:
    ...
    int mRefs;
public:
    WifiCommand(const char *type, lowi_wifi_handle handle, wifi_request_id id)
    ...
    WifiCommand(const char *type, lowi_wifi_interface_handle iface, wifi_request_id id)
...
protected:
    lowi_wifi_handle wifiHandle() {
        return getWifiHandle(mInfo);
    }

    lowi_wifi_interface_handle ifaceHandle() {
