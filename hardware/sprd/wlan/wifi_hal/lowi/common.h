...
const uint32_t SPRD_OUI = 0x001374;
...
typedef void (*wifi_internal_event_handler) (lowi_wifi_handle handle, int events);
...
typedef struct {
    lowi_wifi_handle handle;                             // handle to wifi data
...
wifi_error wifi_register_handler(lowi_wifi_handle handle, int cmd, nl_recvmsg_msg_cb_t func, void *arg);
wifi_error wifi_register_vendor_handler(lowi_wifi_handle handle,
            uint32_t id, int subcmd, nl_recvmsg_msg_cb_t func, void *arg);

void wifi_unregister_handler(lowi_wifi_handle handle, int cmd);
void wifi_unregister_vendor_handler(lowi_wifi_handle handle, uint32_t id, int subcmd);

wifi_error wifi_register_cmd(lowi_wifi_handle handle, int id, WifiCommand *cmd);
WifiCommand *wifi_unregister_cmd(lowi_wifi_handle handle, int id);
WifiCommand *wifi_get_cmd(lowi_wifi_handle handle, int id);
void wifi_unregister_cmd(lowi_wifi_handle handle, WifiCommand *cmd);

interface_info *getIfaceInfo(lowi_wifi_interface_handle);
lowi_wifi_handle getWifiHandle(lowi_wifi_interface_handle handle);
hal_info *getHalInfo(lowi_wifi_handle handle);
hal_info *getHalInfo(lowi_wifi_interface_handle handle);
lowi_wifi_handle getWifiHandle(hal_info *info);
lowi_wifi_interface_handle getIfaceHandle(interface_info *info);
wifi_error wifi_cancel_cmd(wifi_request_id id, lowi_wifi_interface_handle iface);
