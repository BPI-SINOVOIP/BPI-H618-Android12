...
static int sprd_config_init(int fd, struct uart_t *u, struct termios *ti)
{
	return sprd_vendor_config_init(fd, u->bdaddr, ti);
}
...
struct uart_t uart[] = {
	...
	{ "sprd",       0x0000, 0x0000, HCI_UART_H4,   115200, 1500000,
				FLOW_CTL, DISABLE_PM, NULL, sprd_config_init},
