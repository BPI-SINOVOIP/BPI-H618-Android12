...
static inline void printLayer(const std::shared_ptr<Layer>& layer, PlanningOutput* output)
{
    ...
    DLOGD("%11s|  %3d  | %2d | %2d |%4d|%5.3f|%13s|%9s|0x%08x|%11s|0x%08x|%5d,%5d,%5d,%5d|%5d,%5d,%5d,%5d|%4.2f %4.2f| %s",
            ...
            isSoildLayer(layer) ? PACK_COLOR(color) : (uint64_t)layer->bufferHandle(),
