...
public:
   ...
   ~Layer();
    ...
    inline bool  isHandwrittenLayer()   const { return mHandwrittenLayer;}
    inline bool  isHandwrittenBgLayer()   const { return mHandwrittenBgLayer;}
...
private:
	...
	//for eink hand writing
	bool mHandwrittenLayer;
	bool mHandwrittenBgLayer;
