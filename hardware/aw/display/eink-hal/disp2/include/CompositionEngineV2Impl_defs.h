...
const struct DEHardwareInfo HardwareConfigs[CONFIG_MAX_DISPLAY_ENGINE] = {
    {1, 3, 0x00000000}, // DE0: 1 video channel, 3 ui channel, not any other feature
    {1, 1, 0x00000000}, // DE1: 1 video channel, 1 ui channel, not any other feature
};
...
const struct DEHardwareInfo HardwareConfigs[CONFIG_MAX_DISPLAY_ENGINE] = {
    {1, 3, eHybridChannelWithAlpha | eAfbcBufferSupported}, // DE0: 1 video channel, 3 ui channel, not any other feature
    {1, 1, eHybridChannelWithAlpha},                        // DE1: 1 video channel, 1 ui channel, not any other feature
};
#define CONFIG_MAX_DISPLAY_ENGINE   2
...
#elif defined(_board_ceres_) || defined(_board_peony_) || defined(_board_epic_)
#define CONFIG_MAX_DISPLAY_ENGINE   2
#define CONFIG_MAX_BANDWIDTH_LEVE   3
...
const struct DEHardwareInfo HardwareConfigs[CONFIG_MAX_DISPLAY_ENGINE] = {
    {2, 2, eHybridChannelWithAlpha}, // DE0: 2 video channel, 2 ui channel, not any other feature
    {1, 2, eHybridChannelWithAlpha}, // DE1: 1 video channel, 2 ui channel, not any other feature
};
