...
#ifndef ANDROID_COMPONENTS_DECODERS_H263_H263DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_H263_H263DECCOMPONENT_H_
...
class H263DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  H263DecComponent(const char *name, c2_node_id_t id,
                   const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~H263DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(H263DecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_H263_H263DECCOMPONENT_H_
