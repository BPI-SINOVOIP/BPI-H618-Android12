...
#ifndef ANDROID_COMPONENTS_DECODERS_AVC_AVCDECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_AVC_AVCDECCOMPONENT_H_
...
namespace android {
class AvcDecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  AvcDecComponent(const char *name, c2_node_id_t id,
                  const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~AvcDecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(AvcDecComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_AVC_AVCDECCOMPONENT_H_
