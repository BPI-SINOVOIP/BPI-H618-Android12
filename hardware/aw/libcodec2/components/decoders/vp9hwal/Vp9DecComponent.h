...
#ifndef ANDROID_COMPONENTS_DECODERS_VP9HWAL_VP9DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_VP9HWAL_VP9DECCOMPONENT_H_
...
class Vp9DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Vp9DecComponent(const char *name, c2_node_id_t id,
                  const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Vp9DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(Vp9DecComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_VP9HWAL_VP9DECCOMPONENT_H_
