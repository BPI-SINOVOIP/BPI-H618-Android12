...
#ifndef ANDROID_COMPONENTS_DECODERS_VC1_VC1DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_VC1_VC1DECCOMPONENT_H_
...
class Vc1DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Vc1DecComponent(const char *name, c2_node_id_t id,
                  const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Vc1DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(Vc1DecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_VC1_VC1DECCOMPONENT_H_
