...
#ifndef ANDROID_COMPONENTS_DECODERS_DIVX_DIVXDECCOMPONENT_H
#define ANDROID_COMPONENTS_DECODERS_DIVX_DIVXDECCOMPONENT_H
...
namespace android {
class DivxDecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  DivxDecComponent(const char *name, c2_node_id_t id,
                   const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~DivxDecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(DivxDecComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_DIVX_DIVXDECCOMPONENT_H
