...
#ifndef ANDROID_COMPONENTS_DECODERS_MJPEG_MJPEGDECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_MJPEG_MJPEGDECCOMPONENT_H_
...
class MjpegDecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  MjpegDecComponent(const char *name, c2_node_id_t id,
                    const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~MjpegDecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(MjpegDecComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_MJPEG_MJPEGDECCOMPONENT_H_
