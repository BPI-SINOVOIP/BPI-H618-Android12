...
#ifndef ANDROID_COMPONENTS_DECODERS_MPEG4_MPEG4DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_MPEG4_MPEG4DECCOMPONENT_H_
...
class Mpeg4DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Mpeg4DecComponent(const char *name, c2_node_id_t id,
                    const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Mpeg4DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(Mpeg4DecComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_MPEG4_MPEG4DECCOMPONENT_H_
