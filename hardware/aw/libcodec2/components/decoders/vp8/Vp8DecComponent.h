...
#ifndef ANDROID_COMPONENTS_DECODERS_VP8_VP8DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_VP8_VP8DECCOMPONENT_H_
...
class Vp8DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Vp8DecComponent(const char *name, c2_node_id_t id,
                  const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Vp8DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(Vp8DecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_VP8_VP8DECCOMPONENT_H_
