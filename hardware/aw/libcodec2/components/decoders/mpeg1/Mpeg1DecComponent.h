...
#ifndef ANDROID_COMPONENTS_DECODERS_MPEG1_MPEG1DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_MPEG1_MPEG1DECCOMPONENT_H_
...
class Mpeg1DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Mpeg1DecComponent(const char *name, c2_node_id_t id,
                    const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Mpeg1DecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(Mpeg1DecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_MPEG1_MPEG1DECCOMPONENT_H_ _
