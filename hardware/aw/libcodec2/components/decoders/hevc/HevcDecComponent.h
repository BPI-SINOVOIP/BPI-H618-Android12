...
#ifndef ANDROID_COMPONENTS_DECODERS_HEVC_HEVCDECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_HEVC_HEVCDECCOMPONENT_H_
...
class HevcDecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  HevcDecComponent(const char *name, c2_node_id_t id,
                   const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~HevcDecComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(HevcDecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_HEVC_HEVCDECCOMPONENT_H_
