...
#ifndef ANDROID_COMPONENTS_DECODERS_MPEG2_MPEG2DECCOMPONENT_H_
#define ANDROID_COMPONENTS_DECODERS_MPEG2_MPEG2DECCOMPONENT_H_
...
class Mpeg2DecComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  Mpeg2DecComponent(const char *name, c2_node_id_t id,
                    const std::shared_ptr<IntfImpl> &intfImpl);
  virtual ~Mpeg2DecComponent();
  /**
 ...
 private:
  ...
  C2_DO_NOT_COPY(Mpeg2DecComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_DECODERS_MPEG2_MPEG2DECCOMPONENT_H_
