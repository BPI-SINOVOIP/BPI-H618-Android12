...
#ifndef ANDROID_COMPONENTS_ENCODERS_AVC_AVCENCCOMPONENT_H_
#define ANDROID_COMPONENTS_ENCODERS_AVC_AVCENCCOMPONENT_H_
...
class AvcEncComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  AvcEncComponent(const char *name, c2_node_id_t id,
                  const std::shared_ptr<IntfImpl> &intfImpl);

  virtual ~AvcEncComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(AvcEncComponent);
};
}  // namespace android

#endif  // ANDROID_COMPONENTS_ENCODERS_AVC_AVCENCCOMPONENT_H_
