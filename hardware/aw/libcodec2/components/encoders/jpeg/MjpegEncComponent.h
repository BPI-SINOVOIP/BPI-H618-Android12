...
#ifndef ANDROID_COMPONENTS_ENCODERS_JPEG_MJPEGENCCOMPONENT_H_
#define ANDROID_COMPONENTS_ENCODERS_JPEG_MJPEGENCCOMPONENT_H_
...
class MjpegEncComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  MjpegEncComponent(const char *name, c2_node_id_t id,
                    const std::shared_ptr<IntfImpl> &intfImpl);

  virtual ~MjpegEncComponent();
 ...
 private:
  std::unique_ptr<VencComponent> mCodec;
  C2_DO_NOT_COPY(MjpegEncComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_ENCODERS_JPEG_MJPEGENCCOMPONENT_H_
