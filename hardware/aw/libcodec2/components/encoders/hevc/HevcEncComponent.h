...
#ifndef ANDROID_COMPONENTS_ENCODERS_HEVC_HEVCENCCOMPONENT_H_
#define ANDROID_COMPONENTS_ENCODERS_HEVC_HEVCENCCOMPONENT_H_
...
class HevcEncComponent : public HwC2Component {
 public:
  class IntfImpl;
  std::shared_ptr<IntfImpl> mIntf;

  HevcEncComponent(const char *name, c2_node_id_t id,
                   const std::shared_ptr<IntfImpl> &intfImpl);

  virtual ~HevcEncComponent();
 ...
 private:
  ...
  C2_DO_NOT_COPY(HevcEncComponent);
};

}  // namespace android

#endif  // ANDROID_COMPONENTS_ENCODERS_HEVC_HEVCENCCOMPONENT_H_
