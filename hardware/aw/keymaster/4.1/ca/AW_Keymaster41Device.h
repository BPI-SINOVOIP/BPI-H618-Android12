...
#ifndef HIDL_aw_hardware_keymaster_V4_1_AndroidKeymaster41Device_AW_H_
#define HIDL_aw_hardware_keymaster_V4_1_AndroidKeymaster41Device_AW_H_
...
class AndroidKeymaster41Device_AW
    : public IKeymasterDevice,
      public aw::hardware::keymaster::V4_0::implementation::AndroidKeymaster4Device_AW {
    using super = aw::hardware::keymaster::V4_0::implementation::AndroidKeymaster4Device_AW;

  public:
    using ::android::hardware::keymaster::V4_1::IKeymasterDevice::registerAsService;
    AndroidKeymaster41Device_AW();
    virtual ~AndroidKeymaster41Device_AW();
...
#endif  // HIDL_aw_hardware_keymaster_V4_1_AndroidKeymaster41Device_AW_H_
