...
class AW_RemotelyProvisionedComponentDevice : public BnRemotelyProvisionedComponent {
    using ScopedAStatus = ::ndk::ScopedAStatus;

  public:
    explicit AW_RemotelyProvisionedComponentDevice(
        AWTACommunicator* ta, AWKeymasterLogger* logger);
    virtual ~AW_RemotelyProvisionedComponentDevice() = default;
