...
VENDOR_PATH := hardware/altobeam/wlan/wpa_supplicant_8_lib
VENDOR_NAME := atbm

ifneq (,$(wildcard $(VENDOR_PATH)))
...
include $(CLEAR_VARS)
LOCAL_MODULE := lib_driver_cmd_$(VENDOR_NAME)
...
LOCAL_VENDOR_INFO_FILE  := $(local-generated-sources-dir)/$(VENDOR_NAME)
$(LOCAL_VENDOR_INFO_FILE):
	touch $@

$(LOCAL_GENERATED_SOURCES): $(SCRIPT_PATH)/auto-gen-source.sh $(VENDOR_PATH) $(LOCAL_VENDOR_INFO_FILE)
	@echo "Generator: $@"
	@./$< $^ $@
