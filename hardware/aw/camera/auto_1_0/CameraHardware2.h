...
private:
    ...
    face_detection_states mSmileDetectionState = FACE_DETECTION_UNINITIALIZED;
#endif //__OPEN_SMILEDECTION__
#ifdef __OPEN_BLINKDECTION__
    face_detection_states mBlinkDetectionState = FACE_DETECTION_UNINITIALIZED;
#endif //__OPEN_BLINKDECTION__
#ifdef __OPEN_SMARTDECTION__
    pthread_mutex_t                 mSmartMutex;
    pthread_cond_t                    mSmartCond;
    bool                            mSmartThreadExit = true;
    int                             mSmartMode = 0x01;
    int                             mSmartDiscardFrameNum = 0;
#endif //__OPEN_SMARTDECTION__
};
