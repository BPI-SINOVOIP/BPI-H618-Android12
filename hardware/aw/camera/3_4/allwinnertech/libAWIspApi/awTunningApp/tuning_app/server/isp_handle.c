...
void convert_tuning_cfg_func(HW_U8 group_id, HW_U32 cfg_ids, unsigned char *cfg_data_addr,
	convert_long_func cvt_long, convert_short_func cvt_short)
{
	...
	int attr_len = 0, i = 0;
	unsigned char *cfg_data = cfg_data_addr;
