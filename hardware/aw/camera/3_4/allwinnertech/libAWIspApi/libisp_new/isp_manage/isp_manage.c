...
void __isp_gtm_set_params(struct isp_lib_context *isp_gen)
{
	...
	isp_gen->gtm_entity_ctx.gtm_param->nor_cmd_mode = isp_gen->ae_entity_ctx.ae_param->nor_cmd_mode;
#endif
...
#if (ISP_VERSION == 520 || ISP_VERSION == 521)
	isp_gen->pltm_entity_ctx.pltm_param->nor_cmd_mode = isp_gen->ae_entity_ctx.ae_param->nor_cmd_mode;
#endif
	//pltm sensor_info.
...
#if (ISP_VERSION == 520 || ISP_VERSION == 521)
	if(isp_gen->sensor_info.wdr_mode == 2 && isp_gen->ae_entity_ctx.ae_param->nor_cmd_mode) {
