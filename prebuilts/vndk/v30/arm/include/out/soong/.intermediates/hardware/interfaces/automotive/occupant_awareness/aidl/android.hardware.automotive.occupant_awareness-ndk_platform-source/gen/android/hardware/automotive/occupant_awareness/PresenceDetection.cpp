...
binder_status_t PresenceDetection::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readBool(parcel, &isOccupantDetected);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
  ...
  _aidl_ret_status = AParcel_readInt64(parcel, &detectionDurationMillis);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t PresenceDetection::writeToParcel(AParcel* parcel) const {
  binder_status_t _aidl_ret_status;
  size_t _aidl_start_pos = AParcel_getDataPosition(parcel);
  _aidl_ret_status = AParcel_writeInt32(parcel, 0);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = AParcel_writeBool(parcel, isOccupantDetected);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;

  _aidl_ret_status = AParcel_writeInt64(parcel, detectionDurationMillis);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
