...
binder_status_t HardwareAuthToken::readFromParcel(const AParcel* parcel) {
  ...
  _aidl_ret_status = AParcel_readInt64(parcel, &userId);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
...
binder_status_t HardwareAuthToken::writeToParcel(AParcel* parcel) const {
  ...
  _aidl_ret_status = AParcel_writeInt64(parcel, userId);
  if (_aidl_ret_status != STATUS_OK) return _aidl_ret_status;
